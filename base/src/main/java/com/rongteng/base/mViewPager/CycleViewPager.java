...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    private List<Home_Banner> infos;
    ...
    public void setData(List<ImageView> views, List<Home_Banner> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<Home_Banner> list, ImageCycleViewListener listener, int showPosition) {
    ...
    public interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        void onImageClick(Home_Banner info, int position, View imageView);
    }
}