...
public class AbViewUtil {
     ...
     */
    public static void setTextChanged(CharSequence s, EditText editText) {
...
//        }
     ...
     * @param editText 输入框控件
     */
    public static void setTextTheFirstNotPoint(Editable s, EditText editText) {
        if (s != null && s.length() == 1 && s.toString().equals(".")) {
            editText.setText("");
            return;
        }
    }
